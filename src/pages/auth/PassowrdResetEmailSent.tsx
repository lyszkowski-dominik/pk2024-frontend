  ...
  return (
    <AuthLayout>
      ...
      <p>
        ...
        zresetowanie hasła.
      <br/>
        Jeśli po 5 minutacch nadal nie otrzymałeś maila z resetem hasła spróbuj ponownie.
      </p>
      <p>Kliknij tutaj aby wrócić do strony logowania. <Link to='/login'>Zaloguj</Link></p>
    </AuthLayout>
  );
};
